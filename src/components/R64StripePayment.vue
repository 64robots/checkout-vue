    ...
    <div class="c-mt-6">
      <label class="c-block">
        ...
        <div class="c-relative">
          ...
          <div ref="card_number" class="c-mt-2 c-w-full c-h-10 c-px-10 c-rounded c-border c-border-c-gray-400 c-text-base c-focus:outline-none c-focus:border-c-grayer" style="padding-top: 10px"></div>
        </div>
      </label>
      <R64Alert
        class="c-mt-2"
      ...
      <div class="c-mt-2 c-flex c-items-center">
          ...
          <span class="c-ml-2 c-w-8 c-h-5 c-flex c-items-center c-justify-center c-border c-border-c-gray-400 c-rounded-sm">
    ...
    <div class="c-mt-6 c-flex">
      <div class="c-w-1/2">
        <label class="c-block">
          ...
          <div ref="card_expiry" class="c-mt-2 c-h-10 c-px-3 c-rounded c-border c-border-c-gray-400 c-text-base c-focus:outline-none c-focus:border-c-grayer" style="padding-top: 10px"></div>
          <R64Alert
            class="c-mt-2"
      ...
      <div class="c-w-1/2 c-ml-4">
        <label class="c-block">
          ...
          <div ref="card_cvc" class="c-mt-2 c-h-10 c-px-3 c-rounded c-border c-border-c-gray-400 c-text-base c-focus:outline-none c-focus:border-c-grayer" style="padding-top: 10px"></div>
          <R64Alert
            class="c-mt-2"
